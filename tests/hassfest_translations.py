# Vendored snapshot of Home Assistant core's script/hassfest/translations.py
# Source: https://raw.githubusercontent.com/home-assistant/core/dev/script/hassfest/translations.py
# Snapshot date: 2026-07-04
#
# Not imported directly: tests/test_translations.py loads this source with the
# HA-internal imports (script.translations, .model) patched out, then runs
# gen_strings_schema against strings.json and translations/fr.json exactly
# like the hassfest CI action does. To refresh, re-download the file from the
# URL above and keep this header.
